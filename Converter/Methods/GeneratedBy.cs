...
namespace NHibernateHbmToFluent.Converter.Methods
{
    public class GeneratedBy
    {
            ...
            if (generator != null)
            {
                switch (generator.@class)
                {
                    ...
                    case "native":
                        ...
                        break;
                    default:
                        _builder.AddLine(string.Format(".{0}.{1}", FluentNHibernateNames.GeneratedBy, FluentNHibernateNames.Custom(generator.@class)));
                        break;
                }
            }
        }
        ...
        public static class FluentNHibernateNames
        {
            ...
            public static string Custom(string customName)
            {
                return ReflectionUtility.GetMethodName((IdentityPart ip) => ip.GeneratedBy.Custom(customName)) + string.Format("(\"{0}\")", customName);
            }
        }
    }
}